...
use ElecBundle\Entity\Cart;
use ElecBundle\Form\CartType;
...
class CartController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $carts = $em->getRepository('ElecBundle:Cart')->findAll();
    ...
    {
        $cart = new Cart();
        $form = $this->createForm('ElecBundle\Form\CartType', $cart);
    ...
    {
        $deleteForm = $this->createDeleteForm($cart);
        $editForm = $this->createForm('ElecBundle\Form\CartType', $cart);
