...
use ElecBundle\Entity\OrderInfo;
use ElecBundle\Form\OrderInfoType;
...
class OrderInfoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $orderInfos = $em->getRepository('ElecBundle:OrderInfo')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('ElecBundle\Form\OrderInfoType', $orderInfo);
    ...
    {
        $deleteForm = $this->createDeleteForm($orderInfo);
        $editForm = $this->createForm('ElecBundle\Form\OrderInfoType', $orderInfo);
