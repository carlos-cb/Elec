...
use ElecBundle\Form\CartItemType;
...
class CartItemController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $cartItems = $em->getRepository('ElecBundle:CartItem')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('ElecBundle\Form\CartItemType', $cartItem);
    ...
    {
        $deleteForm = $this->createDeleteForm($cartItem);
        $editForm = $this->createForm('ElecBundle\Form\CartItemType', $cartItem);
