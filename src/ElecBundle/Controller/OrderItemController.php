...
use ElecBundle\Entity\OrderItem;
use ElecBundle\Form\OrderItemType;
...
class OrderItemController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $orderItems = $em->getRepository('ElecBundle:OrderItem')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('ElecBundle\Form\OrderItemType', $orderItem);
    ...
    {
        $deleteForm = $this->createDeleteForm($orderItem);
        $editForm = $this->createForm('ElecBundle\Form\OrderItemType', $orderItem);
